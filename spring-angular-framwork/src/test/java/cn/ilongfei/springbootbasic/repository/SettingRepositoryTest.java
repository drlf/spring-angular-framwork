...
public class SettingRepositoryTest {
	...
	@Test
	public void create() {
		Setting setting = new Setting("appName","angular-basic");
	...
	/*public void update() {
		user = simpleUserRepository.save(user);
		user.setUsername("drlf");
		User tmp = simpleUserRepository.findOne(user.getId());
		assertThat(tmp.getUsername(), is("drlf"));
	}*/
	...
	/*public void testUpdateNameFor() {
		...
		assertThat(tmp.getUsername(), is("dddlf"));
	}*/
